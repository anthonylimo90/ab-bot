...
interface DemoPortfolioStore {
  ...
  updatePrices: (
    updates: { marketId: string; outcome: "yes" | "no"; price: number }[],
  ) => void;
  ...
  (set, get) => ({
        ...
        set({
          error:
            err instanceof Error
              ? err.message
              : "Failed to fetch demo positions",
          isLoading: false,
        });
      }
    },
    ...
    fetchAll: async () => {
      ...
      try {
        ...
        set({
          error:
            err instanceof Error ? err.message : "Failed to fetch demo data",
          isLoading: false,
        });
      }
    },
    ...
    reset: async () => {
      ...
      try {
        ...
        set({
          error:
            err instanceof Error ? err.message : "Failed to reset portfolio",
          isLoading: false,
        });
        throw err;
      }
