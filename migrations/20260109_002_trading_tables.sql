...
CREATE INDEX idx_tracked_wallets_enabled ON tracked_wallets(enabled);
CREATE INDEX idx_tracked_wallets_pnl ON tracked_wallets(total_pnl DESC);
...
CREATE INDEX idx_stop_loss_position ON stop_loss_rules(position_id);
CREATE INDEX idx_stop_loss_market ON stop_loss_rules(market_id);
CREATE INDEX idx_stop_loss_activated ON stop_loss_rules(activated) WHERE activated = TRUE AND executed = FALSE;
...
CREATE INDEX idx_exec_reports_market ON execution_reports(market_id);
CREATE INDEX idx_exec_reports_executed ON execution_reports(executed_at);
CREATE INDEX idx_exec_reports_source ON execution_reports(source);
...
CREATE INDEX idx_positions_source_wallet ON positions(source_wallet) WHERE source_wallet IS NOT NULL;
