...
CREATE INDEX IF NOT EXISTS idx_pending_order_signatures_user_id ON pending_order_signatures(user_id);
-- Index for cleanup of expired orders
CREATE INDEX IF NOT EXISTS idx_pending_order_signatures_expires_at ON pending_order_signatures(expires_at);
