...
use polymarket_core::api::polygon::AssetTransfer;
...
fn calculate_activity_spread(distribution: &[u64; 24]) -> f64 {
...
fn detect_opposing_positions(transfers: &[AssetTransfer]) -> u64 {
    if transfers.is_empty() {
        return 0;
    }
